...
/** Las coronas del matrimonio: en el rito bizantino se corona a los esposos. */
export const IconCrowns = (props: IconProps) => (
  <Svg {...props}>
    <path d="M2.5 15V9.5l2.5 2 2.5-3.5 2.5 3.5 2.5-2V15z" />
    <path d="M14 19v-5.5l2.5 2 2.5-3.5 2.5 3.5" />
    <path d="M14 19h7.5v-4" />
  </Svg>
);

/** La cuna: la espera de un hijo. */
export const IconCradle = (props: IconProps) => (
  <Svg {...props}>
    <path d="M4 11h16l-1.5 7h-13z" />
    <path d="M6 11c0-3.3 2.7-6 6-6" />
    <path d="M4 18l-1 2M20 18l1 2" />
  </Svg>
);

/** La paloma: la paz y el Espíritu. */
export const IconDove = (props: IconProps) => (
  <Svg {...props}>
    <path d="M20 6c-1.5 0-2.7.6-3.6 1.5L9 15H6a3 3 0 01-3-3 3 3 0 013-3h2.5" />
    <path d="M16.4 7.5c.7 2.4-.2 4.9-2.4 6.3" />
    <path d="M9 15l-1 5" />
    <path d="M20 6l1.5-1.5" />
  </Svg>
);

/** La lámpara encendida: la que se guarda ante el icono y no se apaga. */
export const IconLamp = (props: IconProps) => (
  <Svg {...props}>
    <path d="M12 2.5v3" />
    <path d="M8 5.5h8l-1.5 3.5H9.5z" />
    <path d="M9.5 9c-1.5 1.2-2.5 3-2.5 5a5 5 0 0010 0c0-2-1-3.8-2.5-5" />
    <path d="M12 12v4" />
  </Svg>
);
